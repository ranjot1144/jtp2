...
(function ($, pluginName) {
    ...
    Plugin.prototype.init = function () {
        ...
        zeynep.find("[data-submenu]").on("click", function (event) {
            ...
            !zeynep.hasClass("submenu-opened") &&
                zeynep.addClass("submenu-opened");
        ...
        zeynep.find("[data-submenu-close]").on("click", function (event) {
            ...
            !zeynep.find(".submenu.opened").length &&
                zeynep.removeClass("submenu-opened");
        ...
        this.options.htmlClass &&
            !$("html").hasClass("zeynep-initialized") &&
            $("html").addClass("zeynep-initialized");
