...
var flexdropdownmenu = {
	...
	menuarrowpath: base_url + '/../assets/images/menu/menu-arrow-active.svg', //full URL or path to right arrow image
	arrowpath: base_url + '/../assets/menu/submenu-arrow.svg', //full URL or path to right arrow image
	...
	showbox: function ($, $target, $flexmenu, e) {
		...
		$flexmenu.data('timers').showtimer = setTimeout(function () {
			$target.addClass('selected');
			$flexmenu.show(flexdropdownmenu.animspeed)
	...
	buildflexmenu: function ($, $menu, $target) {
		...
		$lis.each(function (i) {
			...
			$li.children("a:eq(0)").append('<img src="' + flexdropdownmenu.menuarrowpath + '" class="rightarrowclass" style="border:0;" />')
